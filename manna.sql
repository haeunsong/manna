...
CREATE TABLE `board` (
  ...
  `writerEmail` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`boardNumber`),
  KEY `writerEmail` (`writerEmail`),
  CONSTRAINT `board_ibfk_1` FOREIGN KEY (`writerEmail`) REFERENCES `user` (`email`)
...
-- Dump completed on 2024-03-16  7:50:17
